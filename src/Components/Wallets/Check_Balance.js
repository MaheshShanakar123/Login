    ...
    return (
        <div className="col-md-9">
            ...
            <div className="row getButton">
                <button type="submit" class="btn btn-primary offset-md-4 col-md-4 balancebutton" data-toggle="modal" data-target="#myModal" onClick={balance}>Get Balance</button>
            </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div className="row">
                                {amount ? '' : <button type="submit" class="btn btn-primary offset-md-3 col-md-4 server" disabled={!password} onClick={() => getBalance(userData.user.Balance)}>Get Balance</button>}
